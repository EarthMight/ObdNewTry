...
/**
 * Configuration com.trueapp.odbblut.activity.
 */
public class ConfigActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public static final String IMPERIAL_UNITS_KEY = "imperial_uni ts_preference";
    ...
    public static int getObdUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs.
                getString(ConfigActivity.OBD_UPDATE_PERIOD_KEY, "1"); // 4 as in seconds
        int period = 1000; // by default ms
